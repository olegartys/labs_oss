...
-- DROP TABLE IF EXISTS ${env:LAB_HIVE_JSON_ARRAY_TABLE_NAME};
DROP TABLE IF EXISTS ${env:LAB_HIVE_JSON_RAW_TABLE_NAME};

-- Create table from JSON Array

--CREATE EXTERNAL TABLE ${env:LAB_HIVE_JSON_ARRAY_TABLE_NAME} (
...
CREATE EXTERNAL TABLE ${env:LAB_HIVE_JSON_RAW_TABLE_NAME} (
        IsAdult INT,
        PostSize BIGINT,
        Crawled STRING,
        Country STRING,
